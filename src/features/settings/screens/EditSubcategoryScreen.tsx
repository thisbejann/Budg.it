...
export function EditSubcategoryScreen() {
  ...
  const route = useRoute<EditSubcategoryRouteProp>();
  ...
  const loadData = async () => {
    try {
      ...
      const sub = await CategoryRepository.getSubcategoryById(subcategoryId);
      ...
      const cat = await CategoryRepository.getById(sub.category_id);
      setCategory(cat);
